export const events = [
...

  {
    ...
    description: "The Student Guidance Cell conducted a Mock Interview Session across Software Engineering, UI/UX Design, and Digital Marketing domains. The session aimed to provide real interview experience and prepare students for placements. Participants showed great enthusiasm, professionalism, and a strong willingness to improve. The event helped boost confidence and readiness for upcoming career opportunities.",
    date: "2026-04-19",
...

  {
    ...
    description:
      "We successfully organized a Substance Awareness Program for our first-year students, highlighting the importance of informed choices and healthy lifestyles.",
    date: "2024-09-30",
    image:
...

  {
    ...
    description:
      "Day 2 of our workshop focused on web development, Git, and GitHub, helping students grow their technical skills and confidence.",
    date: "2023-09-15",
    image:
...

  {
    ...
    description:
      "Students learned the basics of web development and how to use Git and GitHub in this introductory workshop.",
    date: "2023-05-13",
    image:
